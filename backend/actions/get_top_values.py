...
class GetTopValuesAction(BaseAction):
    @property
    def name(self) -> str:
    ...
    def description(self) -> str:
        return "Find the highest-performing values grouped by a categorical field."
    ...
    def execute(self, df, params: Dict[str, Any], real_column_map: Dict[str, str]) -> Any:
        ...
        grouped = df.groupby(group_by)[metric].sum().sort_values(ascending=False).head(limit)
